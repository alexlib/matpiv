...
%measured in pixels or pixels/cm.
%
%This implementation uses the general normalized x-corr function
%normxcorr2_general by Dirk Padfield:
%http://www.mathworks.com/matlabcentral/fileexchange/29005-generalized-normalized-cross-correlation
%
%See also: MATPIV, INTPEAK, DEFINEWOCO, PIXEL2WORLD, MULTIPASS, SNRFILT,
%GLOBFILT LOCALFILT, NORMXCORR2_GENERAL
...
y=x; u=x; v=x; SnR=x; Pkh=x; u2=x; v2=x;
