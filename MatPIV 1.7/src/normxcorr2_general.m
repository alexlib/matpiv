...
if nargin~=2, disp(['Wrong number of input arguments to ',mfilename]),return, end
T = varargin{1};
A = varargin{2};
...
% will be a combination of 2, 3, and 5.

newNumber = n;
% Ensure that n is odd.  This removes the problem of blank
% rows/columns on the far ends of the spectrum.
if( rem(newNumber,2) == 0 )
    newNumber = newNumber+1;
end

% Incrementally add two to the size (to keep the value odd) until
